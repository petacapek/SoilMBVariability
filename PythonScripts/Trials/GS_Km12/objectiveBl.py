...
def objectiveBl (x):
    #define parameters
    ##yA, Km, v1, v2, m, g, ce, iX1, eu_i = x[17]
    x0 = np.array(x)
    pars = x[[0, 1, 2, 3, 4, 5, 6, 8]]
    
    #reading all data
    dall = pd.read_csv('../Data/Blagodatskaya2014.csv', sep=',')
    ...
    S_i = d.Sinit[0]
    e_i = x[15]
    X1_i = d.DNAinit[0]/(pars[6]*0.25*pars[7])
    ...
    #initial conditions
    S_i2 = d2.Sinit[0]
    X1_i2 = d2.DNAinit[0]/(pars[6]*0.25*pars[7])

...
def FitBl (x):
    ...
    #initial conditions
    S_i = d.Sinit[0]
    e_i = ((d.Ctot[0]/12.01*10000)*x[14]+x[13])/(((d.Ctot[0]/12.01*10000)*x[14]+x[13])+x[1])
    ...
    e_i2 = ((d2.Ctot[0]/12.01*10000)*x[14]+x[13])/(((d2.Ctot[0]/12.01*10000)*x[14]+x[13])+x[1])
    
    y02 = np.array([S_i2, e_i2, X1_i2, 0])
